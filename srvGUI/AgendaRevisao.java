...
import srvDAO.TestdriveDAO;

/**
 *
 * @author Fernando Candido
 */
public class AgendaRevisao extends javax.swing.JFrame {

    /**
     * Creates new form AgendaRevisao
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        RevisaoDAO reviDAO = new RevisaoDAO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgendaRevisao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgendaRevisao().setVisible(true);
            }
        });
    }
