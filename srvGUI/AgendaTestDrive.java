 ...
 */
public class AgendaTestDrive extends javax.swing.JFrame {

    /**
     * Creates new form AgendaTestDrive
     */
    public AgendaTestDrive() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        TestdriveDAO testDAO = new TestdriveDAO();
        Agendamentos agenda = new Agendamentos();
        agenda.setPlaca(placaField.getText());
        agenda.setDatadrive(dataField.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgendaTestDrive.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgendaTestDrive().setVisible(true);
            }
        });
    }
